...
cityname = ['@上海', '@上海', '@上海', '@上海', '@上海', '@上海', '@上海', '@昆明', '@北京', 
			'@北京', '@北京', '@北京', '@北京', '@成都', '@成都', '@天津', '@天津', '@天津',
			'@济南', '@青岛', '@广州', '@广州', '@深圳', '@南宁', '@南京', '@南京', '@南京', 
			'@无锡', '@苏州', '@郑州', '@宁波', '@杭州', '@杭州', '@厦门', '@福州', '@大连', 
			'@大连', '@沈阳', '@沈阳', '@重庆', '@重庆', '@重庆', '#香港', '#香港', '#香港', 
			'#香港', '#香港', '#香港', '$澳门', '$澳门', '&台湾', '&台湾']
